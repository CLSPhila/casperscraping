...
casper.start("https://ujsportal.pacourts.us/DocketSheets/MC.aspx#", function() {
    this.test.assertExists("select[name='ctl00$ctl00$ctl00$cphMain$cphDynamicContent$cphDynamicContent$searchTypeListControl']")
